...
* [GUI](#GUI)
    ...
    * [.removeAllControllers()](#GUI+removeAllControllers)
    * [.removeAllFolders()](#GUI+removeAllFolders)
    * [.removeAll()](#GUI+removeAll)
    * [.open()](#GUI+open)
    * [.close()](#GUI+close)
    * [.hide()](#GUI+hide)
    * [.show()](#GUI+show)
...
<a name="GUI+removeAllControllers"></a>

### gui.removeAllControllers()
Removes all controller from the GUI instance.

**Kind**: instance method of [<code>GUI</code>](#GUI)  
<a name="GUI+removeAllFolders"></a>

### gui.removeAllFolders()
Removes all subfolder from the GUI instance.

**Kind**: instance method of [<code>GUI</code>](#GUI)  
<a name="GUI+removeAll"></a>
